...
const createCurriculo = async (req, res) => {
  ...
  try {
    const result = await db.query(
      'INSERT INTO curriculo (nome, email, telefone, instituicao, periodo, curso, experiencia) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *',
      [nome, email, telefone, instituicao, periodo, curso, experiencia]
    );
